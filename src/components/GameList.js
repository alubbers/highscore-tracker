 ...
 * @property {Game[]} games - Array of games to display
 * @property {(gameId: string) => void} onGameSelect - Callback when a game is selected
 * @property {(gameId: string) => void} onDeleteGame - Callback when a game is deleted
 */
 ...
 */
export const GameList = ({ games, onGameSelect, onDeleteGame }) => {
  /**
